      ...
      <div className={`${authClasses.shell} relative z-10`}>
        <div className={authClasses.header}>
          ...
          <p className={authClasses.subtitle}>
            Create your ThyroVision account in seconds.
          </p>
        </div>
          ...
          <div className={authClasses.cardInner}>
            <form action={formAction} className="space-y-6">
              ...
              <div className={authClasses.field}>
                <Label htmlFor="fullName" className={authClasses.label}>
                  Full name
                </Label>
                <div className={authClasses.inputWrap}>
                  <User className={authClasses.inputIcon} />
                  <Input
                    id="fullName"
                    name="fullName"
            ...
            <div className={authClasses.footer}>
              <p className="text-sm text-muted-foreground text-center">
                ...
                <Link href="/login" className={authClasses.link}>
                  Sign in
                </Link>
              </p>
            </div>
      ...
      fallback={
        <div className="min-h-screen bg-slate-900 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-slate-400 font-medium">Preparing Signup...</p>
          </div>
        </div>
      }
    >
